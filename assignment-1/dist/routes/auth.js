...
const authSchema_1 = require("../zod schemas/authSchema");
const router = express_1.default.Router();
router.post('/signup', (0, zod_1.validateSchema)(authSchema_1.authSchema), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
